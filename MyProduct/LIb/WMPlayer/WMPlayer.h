...
/** 锁定屏幕方向按钮 */
@property (nonatomic, strong) UIButton                *lockBtn;  //加
/** 系统菊花 */
@property (nonatomic, strong) UIActivityIndicatorView *activity;  //加
/** 重播按钮 */
@property (nonatomic, strong) UIButton                *repeatBtn;  //加
