...
//        [self.lockBtn setImage:[UIImage imageNamed:@"arrow"] forState:UIControlStateNormal];
//        [self.lockBtn setImage:[UIImage imageNamed:@"bofangshu"] forState:UIControlStateSelected];
//        //加
...
//        }];
//         self.lockBtn.alpha         = 0; //加
//        [self addSubview:self.lockBtn];  //加
//
//        
//        
//        //加
...
//        }];
//        [self.activity stopAnimating]; //加
//        [self addSubview:self.activity];//加
//        
//        
//        //加
//        self.repeatBtn = [UIButton buttonWithType:UIButtonTypeCustom];
//        [_repeatBtn setImage:[UIImage imageNamed:@"bofangshu~iphone"] forState:UIControlStateNormal];
//        self.repeatBtn.hidden = YES; //加
//        
//        //加
//        [self.repeatBtn mas_makeConstraints:^(MASConstraintMaker *make) {
//            make.center.equalTo(self);
//        }];
//        [self addSubview:self.repeatBtn]; //加
...
//        [_lockBtn setImage:[UIImage imageNamed:@"arrow"] forState:UIControlStateNormal];
//        [_lockBtn setImage:[UIImage imageNamed:@"ba_back"] forState:UIControlStateSelected];
//    }
//    return _lockBtn;
//}
