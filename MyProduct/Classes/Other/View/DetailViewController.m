...
- (void)toFullScreenWithInterfaceOrientation:(UIInterfaceOrientation )interfaceOrientation
{
    ...
    wmPlayer.frame = CGRectMake(0, 0, LGBScreenW, LGBScreenH);
    wmPlayer.playerLayer.frame =  CGRectMake(0,0,LGBScreenH,LGBScreenW);
    ...
    [wmPlayer.closeBtn mas_remakeConstraints:^(MASConstraintMaker *make) {
        make.right.equalTo(wmPlayer).with.offset((-LGBScreenH/2));
...
- (void)viewDidLoad
{
    ...
    playerFrame = CGRectMake(0, 0, LGBScreenW, (LGBScreenW)*3/4);
