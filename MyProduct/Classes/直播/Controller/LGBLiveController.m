...
@interface LGBLiveController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateWaterFlowLayout>
...
@implementation LGBLiveController
...
-(void)loadData
{
    ...
    [[AFHTTPSessionManager manager] GET:[NSString stringWithFormat:LiveLive,self.page] parameters:nil success:^(NSURLSessionDataTask *task, id responseObject) {
